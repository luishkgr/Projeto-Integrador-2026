...
def montar_tela_editar_funcionario(frame_conteudo, id_funcionario):
    ...
    frame_editar_funcionario = ctk.CTkFrame(
        frame_conteudo,
        width=800,
        height=500,
        border_width=1,
    ...
    frame_editar_funcionario.grid(row=1, column=0, columnspan=3, pady=20)
    frame_editar_funcionario.grid_propagate(False)
    frame_editar_funcionario.grid_columnconfigure(0, weight=1)
    frame_editar_funcionario.grid_columnconfigure(1, weight=1)
