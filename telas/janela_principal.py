...
janela_princpal = ctk.CTk()
janela_princpal.title("Sistema de Horários e Escala de Plantão")
janela_princpal.geometry("1200x700")
janela_princpal.resizable(False, False)
janela_princpal.grid_rowconfigure(0, weight=1)
janela_princpal.grid_rowconfigure(1, weight=1) 
janela_princpal.grid_columnconfigure(0, weight=0)
janela_princpal.grid_columnconfigure(1, weight=0)

largura = 1200
altura = 700

largura_tela = janela_princpal.winfo_screenwidth()
altura_tela = janela_princpal.winfo_screenheight()

x = (largura_tela // 2) - (largura // 2)
y = (altura_tela // 2) - (altura // 2)

janela_princpal.geometry(f"{largura}x{altura}+{x}+{y}")
